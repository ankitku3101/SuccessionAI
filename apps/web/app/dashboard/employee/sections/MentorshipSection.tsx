// sections/MentorshipSection.tsx
"use client"
...
export default function MentorshipSection() {
  ...
  const requestMentor = async (mentorId: string) => {
    ...
    await apiPost("/api/employee/mentorship-request", { mentor_id: mentorId })
    // refresh profile and candidates
    const p = await apiGet("/api/employee/me")
  ...
  return (
    <div className="px-4 lg:px-6">
      ...
      <div className="grid gap-2 text-sm mb-4">
        ...
        {mentorship?.mentor_id && <div><span className="font-medium">Mentor:</span> {mentorship.mentor_id}</div>}
      </div>
